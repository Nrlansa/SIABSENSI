        ...
        <div class="edrea_tm_section animated " id="home">
            <div class="section_inner">
                <div class="edrea_tm_home">
                    ...
                    <h2>Ruangan Laboratorium Project Based Learning 1</h2>

                    <span class="cd-headline rotate-1 ">
                        <!-- ANIMATE TEXT VALUES: zoom, rotate-1, letters type, letters rotate-2, loading-bar, slide, clip, letters rotate-3, letters scale, push,  -->
                        <form action="{{ url('store-pbl1') }}" method="post">
                            @csrf
                            <input type="hidden" name="id_ruangan" value="96bc60df-77ea-42d4-9821-715379af15a9">
